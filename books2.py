...
BOOKS = [
    Book(1, 'Computer Science Pro', 'Isejda', 'A very nice book!', 5, 2012),
    Book(2,'Be fast with FastAPI', 'Isejda', 'A great book!', 5, 2010),
    Book(3, 'Master Endpoints', 'Isejda', 'A awsome book!', 5, 2022),
...
@app.get("/books/filter_by_published_date/", status_code=status.HTTP_200_OK)
